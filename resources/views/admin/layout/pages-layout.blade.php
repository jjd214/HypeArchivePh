...
<html>
	...
	<body>
		...
		<script src="/public/extra-assets/ijaboCropTool-master/ijaboCropTool.min.js"></script>
		<script src="/public/extra-assets/ijaboCropTool-master/jquery-1.7.1.min.js"></script>
		<script>
			window.addEventListener('showToastr', function(event){
				toastr.remove();
				if( event.detail.type == 'info') { toastr.info(event.detail.message); }
				else if( event.detail.type == 'success') { toastr.info(event.detail.message); }
				else if( event.detail.type == 'error') { toastr.info(event.detail.message); }
				else if( event.detail.type == 'warning') { toastr.info(event.detail.message); }
				else { return false; }
			})
		</script>
		@livewireScripts
